...
import suprise.qiuguochao.com.charm.HomePage.HomePage;
import suprise.qiuguochao.com.charm.R;
import suprise.qiuguochao.com.ocr_ui.camera.CameraActivity;
...
public class Typewriting extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_takePicture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Typewriting.this, CameraActivity.class);
