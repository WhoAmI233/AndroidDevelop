package suprise.qiuguochao.com.charm.SQLiteHelper;
...
/**
 * Created by qiuguochao on 2017/2/20.
 */
...
public class DBManager {
    ...
    public long insert(Object obj) {
        ...
        for (Field fd : fields) {
            ...
            if (fieldName.equalsIgnoreCase("_id") || fieldName.equalsIgnoreCase("id") || fieldName.equalsIgnoreCase("serialVersionUID") || fieldName.equalsIgnoreCase("$change")) {
                continue;
            }
    ...
    public void clearTable(Class<?> clazz) {
        db.execSQL("delete from " + DBUtils.getTableName(clazz) + "; update sqlite_sequence SET seq = 0 where name ='"+ DBUtils.getTableName(clazz) +"'");
    }
...
//            String tabName = DBUtils.getTableName(mClazz);
//            String Sql_CheckTable = "SELECT count(*) FROM sqlite_master WHERE type='table' AND name='"+tabName+"'";
//            int row = ExcuteSqlWithResultSum(db,Sql_CheckTable);
//            if(row ==0)
    ...
    public int ExcuteSqlWithResultSum(String sql){
