...
public class LuckyView extends LinearLayout implements Runnable,View.OnTouchListener {
     ...
     * 与文字对应的图片
     */
    private int[] mImgs = new int[] { R.drawable.fortunebigwheel_danfan, R.drawable.fortunebigwheel_ipad,
            R.drawable.fortunebigwheel_sorry, R.drawable.fortunebigwheel_iphone, R.drawable.fortunebigwheel_meizi,
            R.drawable.fortunebigwheel_sorry , R.drawable.fortunebigwheel_iphone, R.drawable.fortunebigwheel_meizi,
            R.drawable.fortunebigwheel_sorry};
    ...
    public void init(){
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.fortunebigwheel_jiugongge_item, this);
        ...
        wheel = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel);
        wheel1 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel1);
        wheel2 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel2);
        wheel3 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel3);
        wheel4 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel4);
        wheel5 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel5);
        wheel6 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel6);
        wheel7 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel7);
        wheel8 = BitmapFactory.decodeResource(getResources(), R.drawable.fortunebigwheel_wheel8);
    }
